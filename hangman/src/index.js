...
//word array
const question = [
  "The Chosen Category Is Kananda Movies"
];
...
const hints = [
  [
    "Based on Forest Officer",
    "Dr. Rajkumar Last Film",
    "Rvi Ninu Agasadinda(Song)",
    "Sagar, a lawyer, quits his profession to do painting.",
    "Bramin Boy Discover the connection to the Royal Varma Family",
    "Hutidhare Kannda nadi nali hutabeku",
    "Film Based On Character of Arjuna"
  ]
];
