...
<body style="background: linear-gradient(-445deg,#1470d4,#20a5b985,#079cef)">
    ...
    <div class="signupbox">
        <form name="Newuser" action="includes/ConfigPhpFiles/new_user_registration.php" method="post" enctype="multipart/form-data">
            <fieldset style=" border: 5px groove white">
                <center>


                    <br>
                    <h4><u>Student Registration Page</u></h4><br>
                    ...
                    <p>Photo:<p6 style="color:red">*</p6>
                        ...
                        <p6 style="color:red">Note: The image size(jpg,jpeg only) Should be less than 100kb only. </p6>
                    </p>
                    <br>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Have already Registered?</b><a style="color:blue; font-size:20px; font-weight:bolder" href="login.php">Click Here</a><br><br>
            </fieldset>
        </form>
    </div>
</body>
